                  ...
                  <div class="row">
                    ...
                    <div class="col-6 mb-3">
                      ...
                      <select name="is_header" class="form-control">
                        ...
                        <option value="yes" {{ old('is_header') == 'yes' ? 'selected' : '' }} {{ $categories->is_header == 'yes' ? 'selected' : ''  }}>Yes</option>
                        <option value="no" {{ old('is_header') == 'no' ? 'selected' : '' }} {{ $categories->is_header == 'no' ? 'selected' : ''  }}>No</option>
                      </select>
